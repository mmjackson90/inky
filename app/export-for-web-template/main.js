    ...
    function continueStory(firstTime) {
        ...
        while(story.canContinue) {
            ...
            for(var i=0; i<tags.length; i++) {
                ...
                //CHECKPOINT, LOAD_CHECKPOINT and CLEAR_CHECKPOINT - allows for saving and loading of state.
                    ...
                    //Load story state if extant
                    var state = localStorage.getItem("storyState") || '';
                    if(state!=""){
